...
def preprocess_input_with_watermark_and_silverline_check(input_folder, output_folder, watermark_folder, silverline_folder, watermark_threshold, silverline_threshold):
        ...
        if os.path.isdir(class_folder):
            ...
            for filename in os.listdir(class_folder):
                if filename.endswith('.jpg') or filename.endswith('.png'):
                    ...
                    # Watermark detection
                    detect_with_templates(source_image, watermark_folder, "Watermark", watermark_threshold)
...
def detect_with_templates(source_image, template_folder, detection_type, threshold):
    ...
    if best_template is not None:
        ...
        matching_percentage = round(max_val * 100, 2)
...
preprocess_input_with_watermark_and_silverline_check(input_folder, output_folder, watermark_folder, silverline_folder, watermark_threshold, silverline_threshold)
