...
def preprocess_input(input_folder, output_folder, silverline_folder):
        ...
        if os.path.isdir(class_folder):
            ...
            for filename in os.listdir(class_folder):
                if filename.endswith('.jpg') or filename.endswith('.png'):
                    ...
                    detect_watermark(resized_image, silverline_images)



def detect_watermark(resized_image, silverline_images):
...
def train_model(input_folder, output_folder, silverline_folder):
    preprocess_input(input_folder, output_folder, silverline_folder)
    ...
    model_final.save("silverline_mobilenetmodel_final1.h5")
    print("mobilenet_silverline_class_indices", training_set.class_indices)
    f = open("mobilenet_silverline_class_indices.txt", "w")
