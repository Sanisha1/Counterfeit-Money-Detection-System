...
def preprocess_input_with_watermark_and_silverline_check(input_folder, output_folder, watermark_folder, watermark_threshold):
...
preprocess_input_with_watermark_and_silverline_check(input_folder, output_folder, watermark_folder, watermark_threshold)
...
# Equivalent to Dense(2, activation='sigmoid', kernel_regularizer=regularizers.l2(0.001))
    ...
    model_final.save("watermark_final.h5")
